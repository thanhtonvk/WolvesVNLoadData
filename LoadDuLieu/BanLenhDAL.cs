...
namespace LoadDuLieu
{
    ...
    class BanLenhDAL
    {
        ...
        {
            List<string> arr = value.Split(new[] { "\n" }, StringSplitOptions.None).ToList();
            ...
            if (lineCountNewFile != lineCountOldFile)
            {
                ...
                foreach (var content in values.Split(new[] { "**" }, StringSplitOptions.None))
                {
                    ...
                    else
                    {
                        ...
                        string urlImage = "C:/Users/Administrator/AppData/Roaming/MetaQuotes/Terminal/Common/Files/" + fileName;
                        client.DownloadFile(urlImage, "D:\\WolvesVN\\WolfTeam\\WolvesServer\\WolvesServer\\Image\\BanLenh\\" + fileName);
                        ...
                        db.AddBanLenh(DateTime.Parse(date[2] + "-" + date[1] + "-" + date[0]), value[1],
                            ...
                            "http://103.29.0.41/Image/BanLenh/" + fileName);
